...
const CACHE='kotoba-note-v22';
const ASSETS=['./','./index.html','./app.js?v=22','./style.css?v=22','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
