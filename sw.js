...
const CACHE='kotoba-note-v17';
const ASSETS=['./','./index.html','./app.js?v=17','./style.css?v=17','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
