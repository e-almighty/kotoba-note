...
const CACHE='kotoba-note-v13';
const ASSETS=['./','./index.html','./app.js?v=13','./style.css?v=13','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
