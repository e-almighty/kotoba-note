...
const CACHE='kotoba-note-v21';
const ASSETS=['./','./index.html','./app.js?v=21','./style.css?v=21','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
