...
const CACHE='kotoba-note-v11';
const ASSETS=['./','./index.html','./app.js?v=11','./style.css?v=11','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
