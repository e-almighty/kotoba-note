...
const CACHE='kotoba-note-v14';
const ASSETS=['./','./index.html','./app.js?v=14','./style.css?v=14','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
