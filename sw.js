...
const CACHE='kotoba-note-v12';
const ASSETS=['./','./index.html','./app.js?v=12','./style.css?v=12','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
