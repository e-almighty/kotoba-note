...
const CACHE='kotoba-note-v18';
const ASSETS=['./','./index.html','./app.js?v=18','./style.css?v=18','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
