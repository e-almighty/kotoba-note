...
const CACHE='kotoba-note-v20';
const ASSETS=['./','./index.html','./app.js?v=20','./style.css?v=20','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
