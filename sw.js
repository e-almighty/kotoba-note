...
const CACHE='kotoba-note-v10';
const ASSETS=['./','./index.html','./app.js?v=10','./style.css?v=10','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
