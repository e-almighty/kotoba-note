...
const CACHE='kotoba-note-v15';
const ASSETS=['./','./index.html','./app.js?v=15','./style.css?v=15','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./iphone-qr.png'];
